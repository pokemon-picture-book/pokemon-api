...
export class initializeTable1570438131357 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "pokemons" ("id" integer NOT NULL, "code" character varying(60), "name" character varying(60), "generation_no" smallint, CONSTRAINT "UQ_e461a209e94074a4ce1c185fb34" UNIQUE ("code"), CONSTRAINT "PK_a3172290413af616d9cfa1fdc9a" PRIMARY KEY ("id"))`, undefined);
