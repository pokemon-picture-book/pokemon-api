...
export class Initialize1569808663499 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "types" ("id" SERIAL NOT NULL, "code" character varying(60), "name" character varying(60), CONSTRAINT "UQ_0888743b52d75e0435c1da667d0" UNIQUE ("code"), CONSTRAINT "PK_33b81de5358589c738907c3559b" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "pokemons" ("id" integer NOT NULL, "code" character varying(60), "name" character varying(60), "generation_no" smallint, "detail" character varying(255) NOT NULL, CONSTRAINT "UQ_e461a209e94074a4ce1c185fb34" UNIQUE ("code"), CONSTRAINT "PK_a3172290413af616d9cfa1fdc9a" PRIMARY KEY ("id"))`, undefined);
